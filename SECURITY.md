...
This policy covers the `prodcycle/compliance-verification` GitHub Action code. For vulnerabilities in the ProdCycle API or platform, please report those separately at [prodcycle.com/security](https://prodcycle.com/security).
